...
public class Utility {
    ...
    public static String getPreferredLocation(Context context) {
        ...
        return prefs.getString(context.getString(R.string.preferences_location_key),
                context.getString(R.string.preferences_location_value));
    }

    public static boolean isMetric(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.preferences_unit_system_key),
                context.getString(R.string.preferences_unit_metric_system_value))
                .equals(context.getString(R.string.preferences_unit_metric_system_value));
    }
