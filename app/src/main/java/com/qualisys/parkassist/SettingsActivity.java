...
public class SettingsActivity extends PreferenceActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        bindPreferenceSummaryToValue(findPreference(getString(R.string.preferences_location_key)));
        bindPreferenceSummaryToValue(findPreference(getString(R.string.preferences_unit_system_key)));
    }
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        if (!mBindingPreference) {
            if (preference.getKey().equals(getString(R.string.preferences_location_key))) {
